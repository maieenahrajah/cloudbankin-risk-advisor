...
export const multidimensionalCorrelations = [
  // Matrix data for correlation heatmap
  [1.00, 0.35, 0.42, -0.28, 0.18, -0.33, 0.52, 0.12],
  [0.35, 1.00, 0.15, 0.22, 0.41, -0.12, 0.08, -0.31],
  [0.42, 0.15, 1.00, -0.05, 0.28, -0.38, 0.44, 0.25],
  [-0.28, 0.22, -0.05, 1.00, 0.33, 0.48, -0.22, -0.18],
  [0.18, 0.41, 0.28, 0.33, 1.00, -0.08, 0.35, 0.05],
  [-0.33, -0.12, -0.38, 0.48, -0.08, 1.00, -0.55, -0.28],
  [0.52, 0.08, 0.44, -0.22, 0.35, -0.55, 1.00, 0.39],
  [0.12, -0.31, 0.25, -0.18, 0.05, -0.28, 0.39, 1.00]
];
