    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Badge 
          ...
          variant={loan.confidenceScore >= 95 ? "destructive" : "secondary"}
        >
          Rejected
        </Badge>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          {loan.decisionFactors.map((factor, index) => (
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          {loan.alternatives.map((alternative, index) => (
